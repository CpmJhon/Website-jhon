...
// User Agent
txt = "";
txt += "<p><b>CPM_JHON Stores Inc</b>: <br>" + adalah reseller akun + "</p>";
txt += "<p><b>game modern</b>: " + buatan akun game + "</p>";
txt += "<p><b>penjualan</b>: " + since 2017. + "</p>";
txt += "<p><b>Peninggalan kami </b>: " + menjamin kualitas produk + "</p>";
txt += "<p><b>yang luar biasa</b>: " + akun game yang sangat aman + "</p>";
txt += "<p><b>dan harga murah </b>: " + untuk semua rangkaian + "</p>";
txt += "<p><b>produk kami.</b>: " + plafom Cpm_Jhon melayani 24 jam + "</p>";
txt += "<p><b>Setiap Hari</b>: <br>" + Salam saya cpm_jhon + "</p>";
